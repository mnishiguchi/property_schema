=begin
The MitsParser class processees raw property data that was fetched from a
client's feed URL. It converts property data into our standardized format,
which will be used when the feed data is persisted.
---
NOTE: Since we define our standardized format here, any change we make here
may affect the rest of the system. Therefore, we must handle this file with
extreme care.
=end
...
class MitsParser
  ...
  # It returns an array of property hashes that are formatted in our schema.
...
private
  ...
  # =======================================================
  # Build our custom hash for a property
  # =======================================================
